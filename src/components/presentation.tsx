...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Krishu also known as Sachin. I'm a developer specializing in AI at Bangalore. I'm Studying at Kristu Jayanti University in Bangalore. I'm passionate about AI, tech, Entrepreneurship and SaaS tech.",
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['AI', 'Developer', 'Bangalore', 'Biker', 'SaaS Builder'].map(
              (tag) => (
                <span
                  key={tag}
